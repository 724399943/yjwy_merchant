			...
			<div class="edordWrap">
				...
				<div class="edomsg">
					...
					<div class="odlmsg">
						<div class="omls">
							<span>支付时间</span>
							<p v-if="orderData.status === '0'">-</p>
							<p v-else>{{orderData.pay_time | time}}</p>
						</div>
						<div class="omls">
							<span>支付流水号</span>
							<p v-if="orderData.status === '0'">-</p>
							<p v-else>1954422577452615</p>
						</div>
						<div class="omls">
							<span>支付方式</span>
							<p v-if="orderData.pay_type==0 && orderData.status !== '0'">支付宝</p>
							<p v-else-if="orderData.pay_type==1 && orderData.status !== '0'">微信</p>
							<p v-else-if="orderData.pay_type==1 && orderData.status !== '0'">银联</p>
							<p v-else-if="orderData.status === '0'">-</p>
						</div>
						<div class="omls">
							<span>支付金额</span>
							<p v-if="orderData.status === '0'">-</p>
							<p v-else>{{orderData.total}}</p>
						</div>
					</div>
				</div>
				<div class="edomsg">
