		...
		<div class="main">
			<div class="edordWrap">
				...
				<div class="edomsg">
					<div class="edmadTop">
						<span>配送信息</span>
						<router-link :to="{name: 'editDeliveryMsg',query:{order_sn : orderData.order_sn,total:dataJson.total}}" v-if="orderData.status==7 || orderData.status == 1 || orderData.status == 8"></router-link>
					</div>
